      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="display-lg leading-[0.95]">
            Reset
            <br />
            your <span className="hl">access</span>
            <br />
            securely.
          </h1>
          <p className="mt-6 max-w-sm text-sm leading-relaxed opacity-80">
            Enter the email tied to your GeneScope account and we'll send a
            secure link to reset your password. Links expire in 30 minutes and
            can only be used once.
          </p>
          <ul className="mt-6 max-w-sm space-y-2 text-sm opacity-75">
            <li>· Check your spam folder if it doesn't arrive.</li>
            <li>· Contact your workspace admin for approved-domain issues.</li>
          </ul>
        </div>
      ...
      <section className="relative flex flex-col justify-between h-full p-6 sm:p-10 lg:p-12 xl:p-14 overflow-hidden">
        ...
        <div className="relative w-full max-w-md mx-auto lg:max-w-lg">
          ...
          <h2 className="mt-3 display-md">
            Recover <span className="hl">account</span>.
          </h2>
